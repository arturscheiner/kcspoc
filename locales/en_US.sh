...
# --- Context Selection ---
MSG_CONFIG_CTX_TITLE="Kubernetes Context Selection"
MSG_CONFIG_CTX_DISC="Discovery: Found the following contexts in your kubeconfig:"
MSG_CONFIG_CTX_PROMPT="Which context do you want to use for this PoC?"
MSG_CONFIG_CTX_INVALID_SEL="Invalid selection. Using default context:"
MSG_CONFIG_CTX_HINT="Tip: To change context later, run 'kubectl config use-context <name>'"
MSG_CONFIG_CTX_ERR_NO_CTX="Error: No Kubernetes context found."
MSG_CONFIG_CTX_ERR_NO_CTX_DESC="Verify if ~/.kube/config exists and is valid."
MSG_CONFIG_CTX_ERR_NO_CTX_FIX="Please configure your cluster access before running this wizard."
