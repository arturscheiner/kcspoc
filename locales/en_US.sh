...
# --- Context Detection ---
MSG_CONFIG_CTX_TITLE="Kubernetes Context Detection"
MSG_CONFIG_CTX_DETECTED="Current Kubernetes Context:"
MSG_CONFIG_CTX_CONN_OK="Connectivity to cluster is PASS."
MSG_CONFIG_CTX_RISK_WARN="CAUTION: You are currently targeting a production-like context:"
MSG_CONFIG_CTX_RISK_PROMPT="Are you sure this is the intended PoC environment? [y/N]"
MSG_CONFIG_CTX_ERR_NO_CTX="Error: No active Kubernetes context found."
MSG_CONFIG_CTX_ERR_NO_CTX_DESC="kubectl config current-context returned no value."
MSG_CONFIG_CTX_ERR_NO_CTX_FIX="To fix this:\n1. Run 'kubectl config get-contexts' to see available clusters.\n2. Run 'kubectl config use-context <name>' to select one."
MSG_CONFIG_CTX_ERR_CONN="Error: Cluster context %s is unreachable."
MSG_CONFIG_CTX_ERR_CONN_DESC="kubectl cluster-info timed out or returned an error."
MSG_CONFIG_CTX_ERR_CONN_FIX="Please check your VPN or cluster credentials."
