...
# --- Seleção de Contexto ---
MSG_CONFIG_CTX_TITLE="Seleção de Contexto Kubernetes"
MSG_CONFIG_CTX_DISC="Descoberta: Encontrei os seguintes contextos no seu kubeconfig:"
MSG_CONFIG_CTX_PROMPT="Qual contexto deseja utilizar para esta PoC?"
MSG_CONFIG_CTX_INVALID_SEL="Seleção inválida. Utilizando o contexto padrão:"
MSG_CONFIG_CTX_HINT="Dica: Para mudar o contexto depois, use 'kubectl config use-context <nome>'"
MSG_CONFIG_CTX_ERR_NO_CTX="Erro: Nenhum contexto Kubernetes encontrado."
MSG_CONFIG_CTX_ERR_NO_CTX_DESC="Verifique se ~/.kube/config existe e é válido."
MSG_CONFIG_CTX_ERR_NO_CTX_FIX="Por favor, configure o acesso ao seu cluster antes de rodar este assistente."
