...
# --- Context Detection ---
MSG_CONFIG_CTX_TITLE="Detecção de Contexto Kubernetes"
MSG_CONFIG_CTX_DETECTED="Contexto Kubernetes Atual:"
MSG_CONFIG_CTX_CONN_OK="Conectividade com o cluster: PASSOU."
MSG_CONFIG_CTX_RISK_WARN="CUIDADO: Você está apontando para um contexto de produção:"
MSG_CONFIG_CTX_RISK_PROMPT="Tem certeza que este é o ambiente de PoC pretendido? [y/N]"
MSG_CONFIG_CTX_ERR_NO_CTX="Erro: Nenhum contexto Kubernetes ativo encontrado."
MSG_CONFIG_CTX_ERR_NO_CTX_DESC="kubectl config current-context não retornou nenhum valor."
MSG_CONFIG_CTX_ERR_NO_CTX_FIX="Para corrigir isso:\n1. Execute 'kubectl config get-contexts' para ver os clusters disponíveis.\n2. Execute 'kubectl config use-context <nome>' para selecionar um."
MSG_CONFIG_CTX_ERR_NO_CTX_FIX="Para corrigir isso:\n1. Execute 'kubectl config get-contexts' para ver os clusters disponíveis.\n2. Execute 'kubectl config use-context <nome>' para selecionar um."
MSG_CONFIG_CTX_ERR_CONN="Erro: O contexto de cluster %s está inacessível."
MSG_CONFIG_CTX_ERR_CONN_DESC="kubectl cluster-info expirou ou retornou um erro."
MSG_CONFIG_CTX_ERR_CONN_FIX="Por favor, verifique sua VPN ou credenciais de acesso ao cluster."
