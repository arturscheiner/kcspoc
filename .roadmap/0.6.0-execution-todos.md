...
- [ ] E-079: Initialize `lib/model/ai/prompts/` for centralized prompt engineering
- [ ] E-080: Implement internal fact-collection service (JSON) for the check reporting flow
- [ ] E-081: Author official KCS "Readiness Checklist" prompt template
- [ ] E-082: Implement AI logic to validate cluster facts against the checklist prompt
- [ ] E-083: Update `check_controller.sh` to trigger the AI-driven audit only during the report generation phase
