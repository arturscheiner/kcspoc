...
- [ ] E-035: Implement `extras_controller` and basic CLI routing for the new command
- [ ] E-036: Extract component lifecycle logic into a unified `extra_pack_service.sh`
- [ ] E-037: Implement `model_remote_catalog` to fetch extra-pack definitions from the remote repository
- [ ] E-038: Refactor `prepare_service` and `destroy_controller` to use the new `extra_pack_service`
- [ ] E-039: Create the `extras` view for tabular display of the online catalog
