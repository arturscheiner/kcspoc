...
## 🤖 AI Log Reporting
- [ ] E-075: Define standardized prompt template and Markdown schema for log analysis
- [ ] E-076: Implement `ai_service_generate_log_report` logic for structured extraction
- [ ] E-077: Update `logs_controller.sh` to orchestrate `--show <hash> --report`
- [ ] E-078: Ensure integration with `report_model.sh` for persistence in `~/.kcspoc/reports/`
