...
- [ ] E-066: Implement `--verify <component>` argument parsing in `config_controller.sh`
- [ ] E-067: Implement `config_service_verify_ai` logic (connectivity and model availability)
- [ ] E-068: Create `config_view_verify_action` for standardized reporting of verification results
- [ ] E-069: Ensure Ollama verification logic is modular and reusable for future AI-powered commands
